...
void IRQ_init(void);
void IRQ_SetPriority(IRQn_Type type , int pri);
void IRQ_Enable(IRQn_Type type);
void IRQ_Disable(IRQn_Type type);

void IRQ_exec(int irq_no);
void IRQ_Regist(int int_id , void (* func)(uint32_t int_sense));
